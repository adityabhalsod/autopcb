...
CATEGORY_ORDER = [
    CAT_PASSIVE, CAT_DIODE, CAT_TRANSISTOR, CAT_ANALOG, CAT_POWER,
    CAT_GATE, CAT_SEQ, CAT_COMB, CAT_MEMORY, CAT_INTERFACE,
    CAT_POWER_SYM, CAT_IO,
]
...
def _build_default_catalogue() -> list[ComponentDef]:
    ...
    items += [
        ComponentDef(
            id="R", name="Resistor", category=CAT_PASSIVE, symbol_type="RES",
        ...
        ComponentDef(
            id="C", name="Capacitor", category=CAT_PASSIVE, symbol_type="CAP",
            pins=[_p("1", side="top"), _p("2", side="bottom")],
            default_params={"value": "100n", "voltage": "16V", "type": "ceramic"},
            param_schema={"value": "str", "voltage": "str", "type": "enum:ceramic|electrolytic|film"},
            spice_template="C{ref} {n1} {n2} {value}",
            color=CATEGORY_COLORS[CAT_PASSIVE],
            description="Capacitor.",
        ),
        ComponentDef(
            id="L", name="Inductor", category=CAT_PASSIVE, symbol_type="IND",
            pins=[_p("1", side="left"), _p("2", side="right")],
        ...
        ComponentDef(
            id="XTAL", name="Crystal", category=CAT_PASSIVE, symbol_type="XTAL",
            pins=[_p("1", side="left"), _p("2", side="right")],
    ...
    items += [
        ComponentDef(
            id="D", name="Diode", category=CAT_DIODE, symbol_type="DIODE",
        ...
        ComponentDef(
            id="DZ", name="Zener Diode", category=CAT_DIODE, symbol_type="ZENER",
            pins=[_p("A", side="left"), _p("K", side="right")],
        ...
        ComponentDef(
            id="LED", name="LED", category=CAT_DIODE, symbol_type="LED",
            pins=[_p("A", side="left"), _p("K", side="right")],
    ...
    items += [
        ComponentDef(
            id="NMOS", name="NMOS", category=CAT_TRANSISTOR, symbol_type="NMOS",
        ...
        ComponentDef(
            id="PMOS", name="PMOS", category=CAT_TRANSISTOR, symbol_type="PMOS",
        ...
        ComponentDef(
            id="NPN", name="NPN BJT", category=CAT_TRANSISTOR, symbol_type="NPN",
        ...
        ComponentDef(
            id="PNP", name="PNP BJT", category=CAT_TRANSISTOR, symbol_type="PNP",
    ...
    items += [
        ComponentDef(
            id="OPAMP", name="Op-Amp", category=CAT_ANALOG, symbol_type="OPAMP",
            pins=[_p("IN+", side="left"), _p("IN-", side="left"),
                  _p("OUT", side="right"), _p("V+", side="top"), _p("V-", side="bottom")],
        ...
        ComponentDef(
            id="CMP", name="Comparator", category=CAT_ANALOG, symbol_type="OPAMP",
        ...
        ComponentDef(
            id="VREF", name="Voltage Reference", category=CAT_ANALOG, symbol_type="VREF",
    ...
    items += [
        ComponentDef(
            id="LDO", name="LDO Regulator", category=CAT_POWER, symbol_type="BLOCK",
            pins=[_p("VIN", side="left", direction="power"),
        ...
        ComponentDef(
            id="BUCK", name="Buck Converter", category=CAT_POWER, symbol_type="BLOCK",
            pins=[_p("VIN", side="left", direction="power"),
                  _p("VOUT", side="right", direction="power"),
                  _p("GND", side="bottom", direction="ground"),
    ...
    for gid, name, sym, n_in, body in gate_specs:
        ...
        items.append(ComponentDef(
            id=gid, name=name, category=CAT_GATE, symbol_type=sym,
            pins=pins, color=CATEGORY_COLORS[CAT_GATE],
    ...
    items += [
        ComponentDef(
            id="DFF", name="D Flip-Flop", category=CAT_SEQ, symbol_type="DFF",
            pins=[_p("D", "input", "left"), _p("CLK", "input", "left"),
                  _p("RST", "input", "left"), _p("Q", "output", "right"),
                  _p("QN", "output", "right")],
            color=CATEGORY_COLORS[CAT_SEQ],
            verilog_template=("always @(posedge CLK or posedge RST)\n"
                              "    if (RST) Q <= 0; else Q <= D;"),
        ),
        ComponentDef(
            id="JKFF", name="JK Flip-Flop", category=CAT_SEQ, symbol_type="DFF",
            pins=[_p("J", "input", "left"), _p("K", "input", "left"),
                  _p("CLK", "input", "left"), _p("Q", "output", "right"),
                  _p("QN", "output", "right")],
            color=CATEGORY_COLORS[CAT_SEQ],
        ),
        ComponentDef(
            id="TFF", name="T Flip-Flop", category=CAT_SEQ, symbol_type="DFF",
            pins=[_p("T", "input", "left"), _p("CLK", "input", "left"),
                  _p("Q", "output", "right")],
            color=CATEGORY_COLORS[CAT_SEQ],
        ),
        ComponentDef(
            id="SR4", name="Shift Reg (4-bit)", category=CAT_SEQ, symbol_type="BLOCK",
            pins=[_p("DIN", "input", "left"), _p("CLK", "input", "left"),
                  _p("Q0", "output", "right"), _p("Q1", "output", "right"),
                  _p("Q2", "output", "right"), _p("Q3", "output", "right")],
            color=CATEGORY_COLORS[CAT_SEQ],
        ),
        ComponentDef(
            id="CNT4", name="Counter (4-bit)", category=CAT_SEQ, symbol_type="BLOCK",
            pins=[_p("CLK", "input", "left"), _p("RST", "input", "left"),
                  _p("EN", "input", "left"),
                  _p("Q0", "output", "right"), _p("Q1", "output", "right"),
                  _p("Q2", "output", "right"), _p("Q3", "output", "right")],
            color=CATEGORY_COLORS[CAT_SEQ],
    ...
    items += [
        ComponentDef(
            id="MUX2", name="MUX 2:1", category=CAT_COMB, symbol_type="MUX",
            pins=[_p("I0", "input", "left"), _p("I1", "input", "left"),
                  _p("S", "input", "bottom"), _p("Y", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
            verilog_template="assign Y = S ? I1 : I0;",
        ),
        ComponentDef(
            id="MUX4", name="MUX 4:1", category=CAT_COMB, symbol_type="MUX",
            pins=[_p("I0", "input", "left"), _p("I1", "input", "left"),
                  _p("I2", "input", "left"), _p("I3", "input", "left"),
                  _p("S0", "input", "bottom"), _p("S1", "input", "bottom"),
                  _p("Y", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
        ),
        ComponentDef(
            id="DEC2_4", name="Decoder 2:4", category=CAT_COMB, symbol_type="BLOCK",
            pins=[_p("A0", "input", "left"), _p("A1", "input", "left"),
                  _p("Y0", "output", "right"), _p("Y1", "output", "right"),
                  _p("Y2", "output", "right"), _p("Y3", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
        ),
        ComponentDef(
            id="HADD", name="Half Adder", category=CAT_COMB, symbol_type="BLOCK",
            pins=[_p("A", "input", "left"), _p("B", "input", "left"),
                  _p("S", "output", "right"), _p("C", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
        ),
        ComponentDef(
            id="FADD", name="Full Adder", category=CAT_COMB, symbol_type="BLOCK",
            pins=[_p("A", "input", "left"), _p("B", "input", "left"),
                  _p("CIN", "input", "left"), _p("S", "output", "right"),
                  _p("COUT", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
        ),
        ComponentDef(
            id="ALU4", name="4-bit ALU", category=CAT_COMB, symbol_type="BLOCK",
            pins=[_p("A", "input", "left"), _p("B", "input", "left"),
                  _p("OP", "input", "bottom"), _p("Y", "output", "right"),
                  _p("CO", "output", "right")],
            color=CATEGORY_COLORS[CAT_COMB],
        ),
    ]
    ...
    items += [
        ComponentDef(
            id="SRAM6T", name="SRAM Cell (6T)", category=CAT_MEMORY, symbol_type="BLOCK",
            pins=[_p("WL", "input", "top"), _p("BL", "inout", "left"),
                  _p("BLB", "inout", "right")],
            color=CATEGORY_COLORS[CAT_MEMORY],
        ),
        ComponentDef(
            id="ROM", name="ROM (LUT)", category=CAT_MEMORY, symbol_type="BLOCK",
            pins=[_p("ADDR", "input", "left"), _p("DATA", "output", "right")],
            color=CATEGORY_COLORS[CAT_MEMORY],
        ),
        ComponentDef(
            id="REGFILE", name="Register File 4x8", category=CAT_MEMORY, symbol_type="BLOCK",
            pins=[_p("RA", "input", "left"), _p("WA", "input", "left"),
                  _p("WD", "input", "left"), _p("WE", "input", "left"),
                  _p("RD", "output", "right")],
            color=CATEGORY_COLORS[CAT_MEMORY],
        ),
        ComponentDef(
            id="FIFO", name="FIFO 16x8", category=CAT_MEMORY, symbol_type="BLOCK",
            pins=[_p("WR", "input", "left"), _p("RD", "input", "left"),
                  _p("DIN", "input", "left"), _p("DOUT", "output", "right"),
                  _p("FULL", "output", "right"), _p("EMPTY", "output", "right")],
            color=CATEGORY_COLORS[CAT_MEMORY],
        ),
    ]
    ...
    items += [
        ComponentDef(
            id="UART", name="UART TX/RX", category=CAT_INTERFACE, symbol_type="BLOCK",
            pins=[_p("CLK", "input", "left"), _p("TXD", "output", "right"),
                  _p("RXD", "input", "left"), _p("BUSY", "output", "right")],
            color=CATEGORY_COLORS[CAT_INTERFACE],
        ),
        ComponentDef(
            id="SPI", name="SPI Master", category=CAT_INTERFACE, symbol_type="BLOCK",
            pins=[_p("SCLK", "output", "right"), _p("MOSI", "output", "right"),
                  _p("MISO", "input", "left"), _p("CS", "output", "right")],
            color=CATEGORY_COLORS[CAT_INTERFACE],
        ),
        ComponentDef(
            id="I2C", name="I2C Master", category=CAT_INTERFACE, symbol_type="BLOCK",
            pins=[_p("SCL", "inout", "right"), _p("SDA", "inout", "right")],
            color=CATEGORY_COLORS[CAT_INTERFACE],
        ),
        ComponentDef(
            id="PWM", name="PWM Generator", category=CAT_INTERFACE, symbol_type="BLOCK",
            pins=[_p("CLK", "input", "left"), _p("DUTY", "input", "left"),
                  _p("OUT", "output", "right")],
            color=CATEGORY_COLORS[CAT_INTERFACE],
        ),
    ]
    ...
    items += [
        ComponentDef(
            id="VDD", name="VDD", category=CAT_POWER_SYM, symbol_type="VDD",
        ...
        ComponentDef(
            id="GND", name="GND", category=CAT_POWER_SYM, symbol_type="GND",
            pins=[_p("G", "ground", "top")],
            color=CATEGORY_COLORS[CAT_POWER_SYM],
        ),
        ComponentDef(
            id="AGND", name="Analog GND", category=CAT_POWER_SYM, symbol_type="GND",
            pins=[_p("G", "ground", "top")],
            color=CATEGORY_COLORS[CAT_POWER_SYM],
        ),
        ComponentDef(
            id="VREF_SYM", name="VREF", category=CAT_POWER_SYM, symbol_type="VDD",
            pins=[_p("V", "power", "bottom")],
            default_params={"vref": "1.25V"},
            param_schema={"vref": "str"},
            color=CATEGORY_COLORS[CAT_POWER_SYM],
        ...
        ComponentDef(
            id="NLABEL", name="Net Label", category=CAT_POWER_SYM, symbol_type="LABEL",
    ...
    items += [
        ComponentDef(
            id="PORT_IN", name="Input Port", category=CAT_IO, symbol_type="PORT_IN",
        ...
        ComponentDef(
            id="PORT_OUT", name="Output Port", category=CAT_IO, symbol_type="PORT_OUT",
        ...
        ComponentDef(
            id="PORT_IO", name="Bidir Port", category=CAT_IO, symbol_type="PORT_IO",
        ...
        ComponentDef(
            id="BUS", name="Bus", category=CAT_IO, symbol_type="BUS",
...
class ComponentLibrary:
    ...
    def search(self, query: str) -> list[ComponentDef]:
        ...
        return [c for c in self._items.values()
                ...
                or q in c.category.lower() or q in c.subcategory.lower()]
...
__all__ = [
    "ComponentDef", "PinDef", "ComponentLibrary",
